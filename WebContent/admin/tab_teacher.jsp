...
<body>
	...
	<div class="easyui-window" id="importFileWindow" title="导入教师信息" iconCls="icon-import" style="width:500px;">
	...
	<div id="teacherWindow" class="easyui-window" style="width:600px;height:400px;">
