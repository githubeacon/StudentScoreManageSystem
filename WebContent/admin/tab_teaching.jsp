...
<script>
	...
	function addTeaching() {
		...
		$(".departmentCb").combobox("reload");
		$("#courseCb").combobox("reload");
		$("#semesterCb").combobox("reload");
...
<body>
	...
	<div id="teachingWindow" class="easyui-window" style="width:600px;height:400px;display:none">
		<form  method="post" id="teachingForm">
			<table style="border-collapse:separate;border-spacing:0px 10px">
				<tr>
					<td>教师:</td>
					<td><input id="departmentCb" name="departmentOfTeacher"/></td>
					<td><input id="teacherCb" style="width:160px" class="easyui-combobox" name="teaching.teacher.id"/></td>
				</tr>
				<tr>
					<td>班级:</td>
					<td><input class="departmentCb" name="departmentOfClass" /></td>
					<td><input class="majorCb easyui-combobox" style="width:160px" name="majorOfClass"/></td>
					<td><input class="classCb easyui-combobox"  style="width:160px" name="teaching.class1.id"/></td>
				</tr>
				<tr>
					<td>课程名字:</td>
